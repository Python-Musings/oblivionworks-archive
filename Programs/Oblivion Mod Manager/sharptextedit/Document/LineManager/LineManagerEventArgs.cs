...
{
	internal delegate void LineManagerEventHandler(object sender, LineManagerEventArgs e);
	internal delegate void LineLengthEventHandler(object sender, LineLengthEventArgs e);
	
	internal class LineManagerEventArgs : EventArgs
	{
		IDocument document;
		int       start;
		int       moved;
	...
	internal class LineLengthEventArgs : EventArgs
	{
		IDocument document;
		int       lineNumber;
		int       lineOffset;
