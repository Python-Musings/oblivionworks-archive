...
namespace ICSharpCode.TextEditor.Document
{
	...
	/*
	internal class PieceTableTextBufferStrategy : ITextBufferStrategy
	{
		protected struct PieceTableDescriptor
		{
			internal bool Buffer;			// False for original, True for modified
		...
		internal char GetCharAt(int offset)
		{
			int off = 0;
			int currdesc = 0;
