...
{
	internal class CaretLeft : AbstractEditAction
	{
	...
	internal class CaretRight : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
	...
	internal class CaretUp : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			Point position = textArea.Caret.Position;
...
//			}
	...
	internal class CaretDown : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			Point position = textArea.Caret.Position;
...
//			}
	...
	internal class WordRight : CaretRight
	{
		public override void Execute(TextArea textArea)
		{
	...
	internal class WordLeft : CaretLeft
	{
		public override void Execute(TextArea textArea)
		{
			Point oldPos = textArea.Caret.Position;
	...
	internal class ScrollLineUp : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
	...
	internal class ScrollLineDown : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			textArea.AutoClearSelection = false;
