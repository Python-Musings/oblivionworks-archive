...
{
	internal class Home : AbstractEditAction
	{
	...
	internal class End : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			LineSegment curLine;
	...
	internal class MoveToStart : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
	...
	internal class MoveToEnd : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
