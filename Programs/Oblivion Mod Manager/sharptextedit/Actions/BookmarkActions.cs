...
{
	internal class ToggleBookmark : AbstractEditAction
	{
	...
	internal class GotoPrevBookmark : AbstractEditAction
	{
	...
	internal class GotoNextBookmark : AbstractEditAction
	{
		Predicate<Bookmark> predicate = null;
	...
	internal class ClearAllBookmarks : AbstractEditAction
	{
		Predicate<Bookmark> predicate = null;
