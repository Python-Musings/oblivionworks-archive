...
namespace ConflictDetector {
    internal class plugin {
        ...
        internal void AddConflict(List<EDID> edids) {
        ...
        internal plugin(string _name,string _omod,bool _active) {
            name=_name;
            omod=_omod;
            active=_active;
    ...
    internal class sorter : IComparer<EDID> {
    ...
    internal class ReportGenerator {
        ...
        internal static bool CheckForVeryMinor;
        internal static bool CheckForMinor;
        internal static bool CheckForMajor;

        internal static bool IncludeEsps;
        internal static bool IgnoreInactiveEsps;
        internal static bool IncludeOmods;
        internal static bool IgnoreInactiveOmods;
                ...
                foreach(OblivionModManager.EspInfo ei in OblivionModManager.Program.Data.Esps) {
                    ...
                    if(ei.Parent==null) {
                        ...
                        try {
                            ...
                            list.AddRange(TesFile.GetIDList("data\\"+ei.FileName, p));
                            plugins.Add(p);
                        } catch {
