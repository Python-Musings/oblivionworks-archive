...
namespace OblivionModManager {
    ...
    internal abstract class CompressionHandler {
        ...
        internal static void CompressFiles(string[] files, string[] FolderStructure, out FileStream CompressedStream, 
        ...
        internal static string DecompressFiles(Stream FileList, Stream CompressedStream, CompressionType type) {
            ...
            default: throw new obmmException("Unrecognised compression type");
            }
        }
    ...
    internal class CompressionProgressBar : SevenZip.ICodeProgress {
        private ProgressForm pf;
        private long TotalSize;

        internal void Init(long totalSize, bool compressing) {
            if(compressing) {
