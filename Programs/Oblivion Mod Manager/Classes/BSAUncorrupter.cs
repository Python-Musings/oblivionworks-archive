...
namespace OblivionModManager.Classes {
    static class BSAUncorrupter {
        internal struct BSAFixResult {
            internal int filesFound;
            internal int filesFixed;
            internal int foldersFound;
            internal int foldersFixed;
            internal int Failed;
        }
        ...
        private class BSAFolderEntry {
            ...
            internal BSAFolderEntry(ulong hash, int files, long offset) {
                Hash=hash;
                Files=files;
                HashOffset=offset;
            }
        ...
        private class BSAFileEntry {
            ...
            internal BSAFileEntry(ulong hash, long offset) {
                Hash=hash;
                HashOffset=offset;
            }
        }
        ...
        internal static BSAFixResult ScanBSA(string[] files) {
            BSAFixResult result=new BSAFixResult();
            foreach(string s in files) ScanBSA(s, ref result);
            return result;
        }
        internal static void ScanBSA(string file, ref BSAFixResult result) {
