...
namespace OblivionModManager {
    internal static class Conflicts {
        internal static void UpdateConflicts() {
            foreach(omod o in Program.Data.omods) if(!o.Hidden) UpdateConflict(o);
        }
        internal static void UpdateConflict(omod o) {
            ...
            foreach(DataFileInfo df in o.AllDataFiles) {
                ...
                if(dfi==null) {
                    if(!File.Exists("Data\\"+df.FileName)) continue;
        ...
        internal static string ConflictReport(omod o) {
