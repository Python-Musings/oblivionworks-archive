...
namespace OblivionModManager.Forms {
    internal partial class ScriptEditor : Form {
        ...
        internal string Result { get { return ""+((char)(byte)scriptType)+result; } }

        internal ScriptEditor(string script) {
            InitializeComponent();
        ...
        internal ScriptEditor(string script, string[] pluginFiles, DataFileInfo[] dataFiles) : this(script) {
        ...
        private struct ControlStruct {
            ...
            internal ControlStruct(byte type, int line) {
                this.type=type;
                this.line=line;
            }
        }
