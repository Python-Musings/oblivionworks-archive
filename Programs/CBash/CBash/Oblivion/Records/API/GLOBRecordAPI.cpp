...
void * GLOBRecord::GetField(FIELD_IDENTIFIERS, void **FieldValues)
    {
    switch(FieldID)
        {
        case 1: //flags1
...
bool GLOBRecord::SetField(FIELD_IDENTIFIERS, void *FieldValue, UINT32 ArraySize)
    {
    switch(FieldID)
        {
        case 1: //flags1
        ...
        case 5: //format
            ...
            break;
        case 6: //value
            FLTV.value.value = *(FLOAT32 *)FieldValue;
            break;
        default:
            break;
        }
...
void GLOBRecord::DeleteField(FIELD_IDENTIFIERS)
    {
    switch(FieldID)
        {
        case 1: //flags1
