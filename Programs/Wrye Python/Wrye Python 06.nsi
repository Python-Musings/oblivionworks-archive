...
; Basic Installer Info
    ...
    VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" "6.0"
...
; The Installation Sections
    ...
    Section "PyWin32 2.17" SecPyWin32
        SetOutPath $INSTDIR
        File "pywin32-217.win32-py2.7.exe"
        HideWindow
        ExecWait "$INSTDIR\pywin32-217.win32-py2.7.exe"
        BringToFront
    SectionEnd
...
LangString DESC_SecPIL ${LANG_ENGLISH} "This is needed for WizBAIN Editor and dds handling."
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${SecPIL} $(DESC_SecPIL)
